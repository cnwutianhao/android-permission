...
import com.runtimeperms.tyhoowu.callback.ExplainReasonCallback
...
import com.runtimeperms.tyhoowu.dialog.DefaultDialog
...
class PermissionBuilder(
    ...
    fun showHandlePermissionDialog(
        ...
        val positiveButton = dialogFragment.getPositiveButton()
        val negativeButton = dialogFragment.getNegativeButton()
    ...
    fun shouldRequestNotificationPermission(): Boolean {
        return specialPermissions.contains(RuntimePerms.POST_NOTIFICATIONS)
    }
